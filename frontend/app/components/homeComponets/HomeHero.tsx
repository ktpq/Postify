  ...
  return (
    <section className="flex justify-center items-center h-[730px]">
        <div className='text-center' data-aos="fade-up" data-aos-duration="1000">
            <h1 className='text-[#1f2838] text-[70px] font-bold'> ยินดีต้อนรับสู่ </h1>
            <h2 className='text-[70px] font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent'> ThaiBlogs </h2>
            <p className='text-[20px] text-[#384152]'> แพลตฟอร์มการเขียนบล็อกภาษาไทยที่ให้คุณแบ่งปันความคิด เรียนรู้จากผู้อื่น และสร้างชุมชนนักเขียนที่แข็งแกร่ง </p>
